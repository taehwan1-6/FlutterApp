// 메인 화면에서 관광지 목록 구성 (관광 전보 오픈 API 연동)화면
...
class _MapPage extends State<MapPage> {
  ...
  String authKey = 'Yox4quwxHE8v9TM6BNSfnwGiwLD6VJLG49kZDdrLztHSxGtgs94ZzVjtoxRHC9PqUsGohO%2BqzoE7PsF8TRkYOA%3D%3D'; // 오픈 API 키 (일반 인증키)
  ...
  void getAreaList({required int area, required int contentTypeId, required int page}) async {
    ...
    String body = utf8.decode(reponse.bodyBytes);
    print(body);
